...
```
cd existing_repo
git remote add origin https://gitlab.com/movierizer/movierizer-api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/movierizer/movierizer-api/-/settings/integrations)
